      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="flex items-center space-x-2">
              <span className="font-bold text-sm tracking-wide text-white">SMA KH. A. WAHID HASYIM</span>
              <span className="text-[10px] bg-emerald-700/80 px-1.5 py-0.5 rounded text-emerald-100 font-mono">TEBUIRENG</span>
            </div>
        ...
        {user && (
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2 border-r border-emerald-800/80 pr-4">
              <div className="text-right hidden md:block">
                <div className="text-xs font-semibold text-white leading-tight">{user.name}</div>
                <div className="mt-0.5">{getRoleBadge(user.role)}</div>
              </div>
              <div className="w-8 h-8 rounded-full bg-emerald-800 border border-emerald-600 flex items-center justify-center text-emerald-200 font-bold text-xs">
            ...
            <button
              onClick={logout}
              className="flex items-center space-x-1.5 text-xs bg-emerald-900/80 hover:bg-emerald-950 text-emerald-200 px-3 py-1.5 rounded border border-emerald-700/50 transition-colors"
